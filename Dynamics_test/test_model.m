function [IP_ratio,torque_rms,model] = test_model(input)
...
for i = 1:N
    ...
    if i == 1
        [model] = find_model(t_i, struct_Controller.param, model_param, model_type, T, T_state);
    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function [model] = find_model(t, param, model_param, model_type, T, T_state)
        Q = param.Q;
        switch coord
            case 'spatial'
                R = T*param.R*T.';
